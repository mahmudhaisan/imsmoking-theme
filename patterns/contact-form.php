...
/**
 * Title: Contact Form
 * Slug: imsmoking-theme/contact-form
...
<p class="has-text-align-left has-default-color has-primary-background-color has-text-color has-background has-link-color" style="margin-bottom:0px;padding-top:5px;padding-right:var(--wp--preset--spacing--10);padding-bottom:5px;padding-left:var(--wp--preset--spacing--10)"><?php esc_html_e( 'Let’s talk', 'imsmoking-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:heading {"textAlign":"left","style":{"typography":{"lineHeight":"1","fontStyle":"normal","fontWeight":"800"}}} -->
<h2 class="wp-block-heading has-text-align-left" style="font-style:normal;font-weight:800;line-height:1"><?php esc_html_e( 'Feel Free To Contact Us.', 'imsmoking-theme' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-left has-accent-color has-text-color" style="margin-top:5px;margin-bottom:var(--wp--preset--spacing--40);line-height:1.7"><?php esc_html_e( 'We’d love to hear from you! Please fill out the form or reach us through the following methods.', 'imsmoking-theme' ); ?></p>
<!-- /wp:paragraph -->
...
<h5 class="wp-block-heading has-text-align-left has-base-color has-text-color" style="margin-bottom:15px"><?php esc_html_e( 'Get Direction', 'imsmoking-theme' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"top":"0px","bottom":"0px"}}},"textColor":"accent"} -->
<p class="has-text-align-left has-accent-color has-text-color" style="margin-top:0px;margin-bottom:0px"><?php esc_html_e( '785 15h Street, Office 478 Berlin, De 81566 6391 Elgin St. Celina, 10299', 'imsmoking-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":5,"style":{"spacing":{"margin":{"bottom":"15px"}}},"textColor":"base"} -->
<h5 class="wp-block-heading has-text-align-left has-base-color has-text-color" style="margin-bottom:15px"><?php esc_html_e( 'Phone Number', 'imsmoking-theme' ); ?></h5>
<!-- /wp:heading -->
...
<p class="has-text-align-left has-accent-color has-text-color has-link-color" style="margin-top:0px;margin-bottom:var(--wp--preset--spacing--10)"><a href="#"><?php esc_html_e( '(629) 555-0129', 'imsmoking-theme' ); ?></a></p>
<!-- /wp:paragraph -->
...
<h6 class="wp-block-heading has-text-align-left has-base-color has-text-color" style="margin-bottom:15px"><?php esc_html_e( 'E-mail', 'imsmoking-theme' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"top":"0px","bottom":"var:preset|spacing|10"}},"elements":{"link":{"color":{"text":"var:preset|color|accent"},":hover":{"color":{"text":"var:preset|color|primary"}}}}},"textColor":"accent"} -->
<p class="has-text-align-left has-accent-color has-text-color has-link-color" style="margin-top:0px;margin-bottom:var(--wp--preset--spacing--10)"><a href="<?php echo esc_url( 'mailto:info@example.com' ); ?>"><?php esc_html_e( 'info@example.com', 'imsmoking-theme' ); ?></a></p>
<!-- /wp:paragraph -->
...
<?php esc_html_e( 'Add Contact form shortcode', 'imsmoking-theme' ); ?>
<!-- /wp:shortcode --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
