 ...
 * Slug: imsmoking-theme/section-title-2
...
<h2 class="wp-block-heading has-base-color has-text-color has-x-large-font-size" style="font-style:normal;font-weight:800;line-height:1"><?php esc_html_e( 'An award winning agency specialized in web design', 'imsmoking-theme' ); ?></h2>
<!-- /wp:heading -->
