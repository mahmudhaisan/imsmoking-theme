 ...
 * Slug: imsmoking-theme/section-title-1
...
<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color has-xx-large-font-size" style="margin-bottom:var(--wp--preset--spacing--20);font-style:normal;font-weight:800;line-height:0.9"><?php esc_html_e( 'Amazing services to build busines growth', 'imsmoking-theme' ); ?></h1>
<!-- /wp:heading -->
