 ...
 * Slug: imsmoking-theme/featured-section-2
 * Categories: featured
...
<!-- wp:pattern {"slug":"imsmoking-theme/section-title-3"} /-->
...
<div class="wp-block-group" style="padding-right:0px;padding-left:0px">
    ...
    <!-- wp:pattern {"slug":"imsmoking-theme/card-2"} /-->
    ...
    <div class="wp-block-column" style="flex-basis:15%"><!-- wp:group {"style":{"border":{"radius":"999px"}},"backgroundColor":"secondary","className":" imsmoking-handler-theme-is-h-w-70 at-h at-w at-flx at-al-itm-ctr at-jfy-cont-ctr","layout":{"type":"constrained"}} -->
    <div class="wp-block-group  imsmoking-handler-theme-is-h-w-70 at-h at-w at-flx at-al-itm-ctr at-jfy-cont-ctr has-secondary-background-color has-background" style="border-radius:999px;"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"900","fontSize":"1.5rem"}}} -->
    <p style="font-size:1.5rem;font-style:normal;font-weight:900"><?php esc_html_e( '2', 'imsmoking-theme' ); ?></p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:group --></div>
    <!-- /wp:column -->
    ...
    <h3 class="wp-block-heading has-text-align-left has-base-color has-text-color " style="margin-bottom:5px;font-size:22px;font-style:normal;font-weight:600"><?php esc_html_e( 'Customize Typography and Colors Style panel', 'imsmoking-theme' ); ?></h3>
    <!-- /wp:heading -->
    ...
    <p class="has-accent-color has-text-color has-link-color has-small-font-size" style="line-height:1.5"><?php esc_html_e( 'Elementum ipsum donec usodales porttitor mauris augue fermentum sagittis elementum.', 'imsmoking-theme' ); ?></p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column --></div>
    <!-- /wp:columns -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Know More', 'imsmoking-theme' ); ?></a></div>
<!-- /wp:button -->
