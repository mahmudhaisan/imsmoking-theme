 ...
 * Slug: imsmoking-theme/featured-section-1
 * Categories: featured
...
<div class="wp-block-column" style="flex-basis:35%"><!-- wp:pattern {"slug":"imsmoking-theme/section-title-2"} /--></div>
<!-- /wp:column -->
...
<div class="wp-block-column"><!-- wp:pattern {"slug":"imsmoking-theme/card-1"} /--></div>
<!-- /wp:column -->
...
<h3 class="wp-block-heading has-base-color has-text-color" style="font-size:22px;font-style:normal;font-weight:700;line-height:1"><?php esc_html_e( 'Free Lifetime Update', 'imsmoking-theme' ); ?></h3>
<!-- /wp:heading -->
...
<p class="has-accent-color has-text-color has-link-color has-small-font-size" style="line-height:1.5"><?php esc_html_e( 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literatu', 'imsmoking-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"22px","fontStyle":"normal","fontWeight":"700","lineHeight":"1"}},"textColor":"base"} -->
<h3 class="wp-block-heading has-base-color has-text-color" style="font-size:22px;font-style:normal;font-weight:700;line-height:1"><?php esc_html_e( 'Modern Minimal Design', 'imsmoking-theme' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"22px","fontStyle":"normal","fontWeight":"700","lineHeight":"1"}},"textColor":"base"} -->
<h3 class="wp-block-heading has-base-color has-text-color" style="font-size:22px;font-style:normal;font-weight:700;line-height:1"><?php esc_html_e( 'Easy Customization', 'imsmoking-theme' ); ?></h3>
<!-- /wp:heading -->
