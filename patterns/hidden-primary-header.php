 ...
 * Slug: imsmoking-theme/hidden-primary-header
 * Inserter: no
 *
...
<p class="has-text-align-center has-default-color has-text-color" style="margin-top:0px;margin-bottom:0px"><strong><?php esc_html_e( 'WP Block Theme Boilerplate : ', 'imsmoking-theme' ); ?></strong><?php esc_html_e( 'Complete your website with millions of Patterns, Templates &amp; Many more.', 'imsmoking-theme' ); ?></p>
<!-- /wp:paragraph -->
    ...
    <div class="wp-block-group alignwide">	
        ...
        <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"},"layout":{"selfStretch":"fill","flexSize":null}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
            <div class="wp-block-group"> 
                <!-- wp:pattern {"slug":"imsmoking-theme/site-identity"} /-->
                <!-- wp:pattern {"slug":"imsmoking-theme/navigation-menu"} /-->
            </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--30)"><?php esc_html_e( 'Get Started', 'imsmoking-theme' ); ?></a></div>
        <!-- /wp:button --></div>
        <!-- /wp:buttons -->
