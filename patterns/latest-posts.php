...
/**
 * Title: Latest Posts
 * Slug: imsmoking-theme/latest-posts
 * Categories: posts
...
<h4 class="wp-block-heading" style="margin-bottom:var(--wp--preset--spacing--30)"><?php esc_html_e( 'Recent Posts', 'imsmoking-theme' ); ?></h4>
<!-- /wp:heading -->
